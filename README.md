...
## تار  یک چارچوب مکان‌یابی منسجم غیرفعال (Passive Coherent Location - PCL) بومی برای مرورگر است که از جریان‌های تله‌متری **HTTP/3 (QUIC)** برای تشخیص و تجسم هوایی در زمان واقعی استفاده می‌کند.
